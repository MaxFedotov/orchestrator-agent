...
# Start the orchestrator-agent daemon in the background
start_daemon () {
	# start up daemon in the background
	$DAEMON_PATH/$DAEMON >> /var/log/${NAME}.log 2>&1 &
	# collect and print PID of started process
	echo $!
	# space for optional processing after starting orchestrator-agent
