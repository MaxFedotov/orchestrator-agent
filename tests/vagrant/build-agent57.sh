...
yum -d 0 -y install Percona-Server-server-57 Percona-Server-shared-57 Percona-Server-client-57 Percona-Server-shared-compat percona-toolkit percona-xtrabackup vim-enhanced
